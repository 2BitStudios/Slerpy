namespace Slerpy
{
    namespace Tests
    {
        ...
        public:
            ...
            {
                Assert::AreEqual(1.0f, Slerpy::Weight::WithType(WeightType::Inverted, 0.0f), EPSILON);
                Assert::AreEqual(0.75f, Slerpy::Weight::WithType(WeightType::Inverted, 0.25f), EPSILON);
                Assert::AreEqual(0.5f, Slerpy::Weight::WithType(WeightType::Inverted, 0.5f), EPSILON);
                Assert::AreEqual(0.25f, Slerpy::Weight::WithType(WeightType::Inverted, 0.75f), EPSILON);
                Assert::AreEqual(0.0f, Slerpy::Weight::WithType(WeightType::Inverted, 1.0f), EPSILON);
            }
