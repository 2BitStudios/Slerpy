...
#define TRANSFORMATION_OFFSET_PARAMS_STANDARD float time, AxisWeightings axisWeightings, bool allowInversion

    DECLARATION_PREFIX Transform TRANSLATE_FUNCTION_NAME(OffsetShake)(TRANSFORMATION_OFFSET_PARAMS_STANDARD);
    DECLARATION_PREFIX Transform TRANSLATE_FUNCTION_NAME(OffsetTwist)(TRANSFORMATION_OFFSET_PARAMS_STANDARD);
    DECLARATION_PREFIX Transform TRANSLATE_FUNCTION_NAME(OffsetThrob)(TRANSFORMATION_OFFSET_PARAMS_STANDARD);
